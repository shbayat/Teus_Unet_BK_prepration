...
#        Test_BPids=[92,93,95,96,98,99,101,103,104,105,108,109,110]
        Test_BPids=[112,114,117,119,120,121,122,124,125]  # removed 118
#        Test_BPids=[128,130,131,132,134,135,136]  #removed 138
        #Select Benign Cores
...
#                    ## Train data-saving
#                    hdf5storage.savemat('Z:/shared/images/ProstateVGH-2/Data/Dataset/InProstate/BK_DS_FFT_train_P%s_%s_%s_%s_%s.mat' %(self.minP.get(),self.maxP.get(),s1,s2,timestr),{
#                                        'data_train':data_train,'label_train':np.asarray(label_train,dtype=float),'inv_train':np.asarray(inv_train,dtype=float),'GS_train':GS_train,'PatientId_train':np.asarray(PatientId_train,dtype=int),'idcore_train':np.asarray(idcore_train,dtype=int),
...
#                            
#                    hdf5storage.savemat('Z:/shared/images/ProstateVGH-2/Data/Dataset/InProstate/BK_DS_FFT_val_P%s_%s_%s_%s_%s.mat' %(self.minP.get(),self.maxP.get(),s1,s2,timestr),{
#                                        'data_val':data_val,'label_val':np.asarray(label_val,dtype=float),'inv_val':np.asarray(inv_val,dtype=float),'GS_val':GS_val,'PatientId_val':np.asarray(PatientId_val,dtype=int),'idcore_val':np.asarray(idcore_val,dtype=int),
#                                        'RF_freq':self.RF_freq})
#                    np.savez('Z:/shared/images/ProstateVGH-2/Data/Dataset/InProstate/BK_DS_FFT_val_high_inv_P%s_%s_%s_%s_%s.mat' %(self.minP.get(),self.maxP.get(),s1,s2,timestr),{
#                                        'data_val':data_val,'label_val':np.asarray(label_val,dtype=float),'inv_val':np.asarray(inv_val,dtype=float),'GS_val':GS_val,'PatientId_val':np.asarray(PatientId_val,dtype=int),'idcore_val':np.asarray(idcore_val,dtype=int),
#                                        'RF_freq':self.RF_freq})
#
#                    print('Data is saved at:Z:/shared/images/ProstateVGH-2/Data/Dataset/InProstate/BK_DS_FFT_val_P%s_%s_%s_%s_%s.mat' %(self.minP.get(),self.maxP.get(),s1,s2,timestr))
