%% save Core IDs
clear all
%% loads all PID and CIS form dataset p1_140
...
load([path 'BK_DS_FFT_train_P111_125___20200805-130102_bal']);
...
% 
% 
idcore_train=[idcore_train1 idcore_train2  idcore_train3 idcore_train4];
...
load([path 'BK_DS_FFT_train_P126_140___20200805-123805_bal']);
idcore_val3=idcore_train;
PID_val3=PatientId_train;
clear data_val GS_val idcore_val label_val RF_freq PatientId_val

% 
% 
idcore_val=[idcore_val1 idcore_val2 idcore_val3];
PID_val=[PID_val1 PID_val2 PID_val3];
% 
save('Lable_IDs_Highinv_balanced_P1_140.mat','idcore_train','PID_train','idcore_val','PID_val');
...
path='Z:\shared\images\ProstateVGH-2\Data\Dataset\InProstate\Ds\Highinv_balanced\';
Highinv_B_labels='Lable_IDs_Highinv_balanced_P1_140';
...
if phase==1
    save('Labels_masks_train_Highinv_bal_p1_140.mat','rf_mask2');
    save('Labels_masks_train_Highinv_bal_p1_140_new.mat','rf_mask2_new');
    save('Labels_masks_train_Highinv_bal_p1_140_new_scale.mat','rf_mask2_new_S');
elseif phase ==2
    save('Labels_masks_val_Highinv_bal_p1_140.mat','rf_mask2');
    save('Labels_masks_val_Highinv_bal_p1_140_new.mat','rf_mask2_new');
    save('Labels_masks_val_Highinv_bal_p1_140_new_scale.mat','rf_mask2_new_S');
elseif phase ==3
    save('Labels_masks_test_Highinv_bal_p1_140.mat','rf_mask2');
    save('Labels_masks_test_Highinv_bal_p1_140_new.mat','rf_mask2_new');
    save('Labels_masks_test_Highinv_bal_p1_140_new_scale.mat','rf_mask2_new_S');
end
