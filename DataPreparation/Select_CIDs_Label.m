...
if phase==1
    save('Labels_masks_train.mat','rf_mask2');
elseif phase ==2
    save('Labels_masks_val.mat','rf_mask2');
elseif phase ==3
    save('Labels_masks_test.mat','rf_mask2');    
end
% save('Z:\shared\images\ProstateVGH-2\Data\Dataset\InProstate\Ds\Labels_masks_train.mat','rf_mask');
