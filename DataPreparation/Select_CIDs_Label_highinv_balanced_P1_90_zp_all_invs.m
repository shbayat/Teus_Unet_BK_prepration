...
% % 
% % 
% idcore_train=[idcore_train1 idcore_train2  idcore_train3]; % total: 66 train
...
% % 
% % 
% idcore_val=[idcore_val1 idcore_val2];  %total: 12 val
% PID_val=[PID_val1 PID_val2];
% % 
% save('Lable_IDs_Highinv_balanced_P1_90_zp.mat','idcore_train','PID_train','idcore_val','PID_val');

%% Test -data - all inv p91-110
path='Z:\shared\images\ProstateVGH-2\Data\Dataset\InProstate\Zero-pad\';
load([path 'BK_DS_FFT_zp_test_P91_100_all_inv__20201105-083808']);
idcore_test1=idcore_test;
PID_test1=PatientId_test;
clear data_test GS_test PatientId_test
% % % 
load([path 'BK_DS_FFT_zp_test_P101_110_all_inv__20201105-084931']);
...
save('Lable_IDs_test_Highinv_P91_110_zp_all_inv.mat','idcore_test','PID_test');
...
Highinv_B_labels='Lable_IDs_test_Highinv_P91_110_zp_all_inv'; %%% All inv zp labels
...
if phase==1
    save('Labels_masks_train_Highinv_bal_p1_90_zp.mat','rf_mask2');
    save('Labels_masks_train_Highinv_bal_p1_90_new_zp.mat','rf_mask2_new');
    save('Labels_masks_train_Highinv_bal_p1_90_new_scale_zp.mat','rf_mask2_new_S');
elseif phase ==2
    save('Labels_masks_val_Highinv_bal_p1_90_zp.mat','rf_mask2');
    save('Labels_masks_val_Highinv_bal_p1_90_new_zp.mat','rf_mask2_new');
    save('Labels_masks_val_Highinv_bal_p1_90_new_scale_zp.mat','rf_mask2_new_S');
elseif phase ==3
...
%     save('Labels_masks_test_Highinv_bal_p91_110_new_scale_zp.mat','rf_mask2_new_S');
    ...
    save('Labels_masks_test_Highinv_bal_p91_110_zp_allinv.mat','rf_mask2');
    save('Labels_masks_test_Highinv_bal_p91_110_new_zp_allinv.mat','rf_mask2_new');
    save('Labels_masks_test_Highinv_bal_p91_110_new_scale_zp_allinv.mat','rf_mask2_new_S');
